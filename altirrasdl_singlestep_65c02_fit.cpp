             ...
             benchmark6502::singlestep_result (*runner)(const benchmark6502::singlestep_corpus&))
{
    try {
        ...
        std::cerr << "AltirraSDL 65C02 best-fit SingleStep failed for "
...
int main(int argc, char** argv)
{
    ...
    bool ok = true;
    ok = run_one(benchmark6502::singlestep_model::wdc65c02, options, altirrasdl_toolbox::run_singlestep_wdc65c02) && ok;
    ok = run_one(benchmark6502::singlestep_model::rockwell65c02, options, altirrasdl_toolbox::run_singlestep_rockwell65c02) && ok;
    ok = run_one(benchmark6502::singlestep_model::synertek65c02, options, altirrasdl_toolbox::run_singlestep_synertek65c02) && ok;
