...
int main(int argc, char** argv)
{
    try {
        ...
        std::cout << "Loading SingleStep clk WDC 65C02 corpus...\n";
        ...
        std::cout << "Loaded SingleStep clk WDC 65C02 corpus: " << corpus.model_path
                  << "  cases=" << corpus.total_cases() << "\n";
        std::cout << "Starting clk WDC 65C02 SingleStep...\n";
        const benchmark6502::singlestep_result result = clk_toolbox::run_singlestep_wdc65c02(corpus);
