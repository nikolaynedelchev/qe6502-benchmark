...
int main()
{
    const benchmark6502::klaus_benchmark_result result = olcNES_toolbox::run_klaus_nmos_standard(5);
    if (!result.passed) {
        std::cerr << "olcNES Klaus2m5 NMOS benchmark failed\n";
        return 1;
    }

    std::cout << "olcNES Klaus2m5 NMOS standard: PASS\n"
