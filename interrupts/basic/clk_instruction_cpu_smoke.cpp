...
{
    auto cpu = clk_toolbox::make_clk_p6502_nmos_instruction_cpu();
    require(cpu->core_name() == "CLK", "unexpected core name");
    require(cpu->model_name() == "P6502", "unexpected model name");
