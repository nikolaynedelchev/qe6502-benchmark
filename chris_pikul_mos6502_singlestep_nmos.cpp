...
int main(int argc, char** argv)
{
    try {
        ...
        std::cout << "Loading SingleStep NMOS corpus...\n";
        ...
        std::cout << "Starting chris-pikul/mos6502 NMOS SingleStep...\n";
        const benchmark6502::singlestep_result result = chris_pikul_mos6502_toolbox::run_singlestep_nmos(corpus);
