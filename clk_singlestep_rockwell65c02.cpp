...
int main(int argc, char** argv)
{
    try {
        ...
        std::cout << "Loading SingleStep clk Rockwell 65C02 corpus...\n";
        ...
        std::cout << "Loaded SingleStep clk Rockwell 65C02 corpus: " << corpus.model_path
                  << "  cases=" << corpus.total_cases() << "\n";
        std::cout << "Starting clk Rockwell 65C02 SingleStep...\n";
        const benchmark6502::singlestep_result result = clk_toolbox::run_singlestep_rockwell65c02(corpus);
