...
int main(int argc, char** argv)
{
    try {
        ...
        std::cout << "Loading SingleStep mame Rockwell 65C02 corpus...\n";
        const benchmark6502::singlestep_corpus corpus = benchmark6502::load_singlestep_corpus(benchmark6502::singlestep_model::rockwell65c02, options);
        std::cout << "Loaded SingleStep mame Rockwell 65C02 corpus: " << corpus.model_path
                  << "  cases=" << corpus.total_cases() << "\n";
        std::cout << "Starting mame Rockwell 65C02 SingleStep...\n";
        const benchmark6502::singlestep_result result = mame_toolbox::run_singlestep_rockwell65c02(corpus);
