...
int main(int argc, char** argv)
{
    try {
        ...
        std::cout << "Loading SingleStep applewin WDC 65C02 best-fit corpus...\n";
        ...
        std::cout << "Loaded SingleStep applewin WDC 65C02 best-fit corpus: " << corpus.model_path
                  << "  cases=" << corpus.total_cases() << "\n";
        std::cout << "Starting applewin WDC 65C02 best-fit SingleStep...\n";
        const benchmark6502::singlestep_result result = applewin_toolbox::run_singlestep_wdc65c02(corpus);
