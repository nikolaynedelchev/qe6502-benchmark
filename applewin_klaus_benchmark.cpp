...
int main()
{
    const benchmark6502::klaus_benchmark_result result = applewin_toolbox::run_klaus_nmos_standard(5);
    if (!result.passed) {
        std::cerr << "applewin Klaus2m5 NMOS benchmark failed\n";
        return 1;
    }

    std::cout << "applewin Klaus2m5 NMOS standard: PASS\n"
