...
#include <vd2/system/int128.h>
	...
	void vdasm_uint128_add(uint64 dst[2], const uint64 x[2], const uint64 y[2]) {
		_addcarry_u64(_addcarry_u64(0, x[0], y[0], (unsigned long long *)&dst[0]), x[1], y[1], (unsigned long long *)&dst[1]);
	}

	void vdasm_uint128_sub(uint64 dst[2], const uint64 x[2], const uint64 y[2]) {
		_subborrow_u64(_subborrow_u64(0, x[0], y[0], (unsigned long long *)&dst[0]), x[1], y[1], (unsigned long long *)&dst[1]);
	}
#else
