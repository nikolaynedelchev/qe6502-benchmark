...
#ifdef _DEBUG
	void *base() { return mpBuffer ? mpBuffer + (-(int)(uintptr)mpBuffer & 15) + 16 : nullptr; }
	const void *base() const { return mpBuffer ? mpBuffer + (-(int)(uintptr)mpBuffer & 15) + 16 : nullptr; }
	size_t size() const { return mLinearSize ? mLinearSize - 28 : 0; }

	void validate();
#else
	void *base() { return mpBuffer ? mpBuffer + (-(int)(uintptr)mpBuffer & 15) : nullptr; }
	const void *base() const { return mpBuffer ? mpBuffer + (-(int)(uintptr)mpBuffer & 15) : nullptr; }
