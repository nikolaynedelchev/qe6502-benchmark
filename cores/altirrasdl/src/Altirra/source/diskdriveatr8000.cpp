...
IATDeviceBus *ATDeviceDiskDriveATR8000::GetDeviceBusById(sint32 id) {
	switch(id) {
...
sint32 ATDeviceDiskDriveATR8000::GetDeviceBusIdByIndex(uint32 index) {
	return index < 2 ? (sint32)index : -1;
}
