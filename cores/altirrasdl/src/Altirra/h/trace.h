...
public:
	...
	virtual void StartIterationNearest(double startTime) = 0;
...
public:
	...
	void StartIterationNearest(double startTime) override final;
...
public:
	...
	uint32 AddString(const wchar_t *s);
	uint32 AddString(VDStringW&& s);
