...
enum ATUIHistoryTimestampMode : uint8 {
	Beam,
	Microseconds,
	Cycles,
	UnhaltedCycles,
...
public:
	...
	virtual void SetTimestampMode(ATUIHistoryTimestampMode mode) = 0;
	virtual void SetTimestampOrigin(uint32 cycles, uint32 unhaltedCycles) = 0;
	virtual void SetTimestampBase(uint32 cycles, uint32 unhaltedCycles) = 0;
	...
	virtual void SetOnTimestampModeChanged(vdfunction<void(ATUIHistoryTimestampMode)> fn) = 0;
	virtual void SetOnTimestampOriginChanged(vdfunction<void(uint32 cyc, uint32 ucyc)> fn) = 0;
};
